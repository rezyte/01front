<template>
    <div id="miniOrders" class="userPanelItem  panelItem">
                ...
                <div class="searchBySome">
                    <div class="searchBySomeWrapper">
                        ...
                        <div class="searchBySomeWrapperWrapper">
                            ...
                            <input v-model="searchText" @input="searchBy" placeholder="جست و جو..." type="text">
                        </div>
                    </div>
                </div>
                <div class="orderByActivationWrapper">
                    ...
                    <div class="statusesWrapper">
                        <div class="singleStatus">
                            <input :checked="shouldCheck(1)" @change="justActive" type="radio" value="1" name="status" id="" class="checks">
                            <label>:فقط تایید شده ها</label>
                        </div>
                        <div class="singleStatus">
                            <input :checked="shouldCheck(0)" @change="justUnactive" type="radio" value="0" name="status" id="" class="checks">
                            <label>:فقط تایید نشده ها</label>
                        </div>
                        <div class="singleStatus">
                            <input :checked="shouldCheck(2)" @change="all" type="radio" value="0" name="status" id="" class="checks">
                            <label>:همه</label>
                        </div>
                    </div>
                </div>
        ...
        <div class="table" v-if="shouldShow.length>0">
            <table v-if="showTable">
                    ...
                    <tr v-for="(order,i) in getOrders" :key="order.id">
                        ...
                        <td class="don" v-if="order.is_confirmed==true">{{ order.phone_number }}</td>
                        <td class="unDon" v-else>

<template>
    <div id="sideMenu">
        ...
        <div id="sideMenuWrapper">
            ...
            <ul>
                <li class="single" v-if="userInfo.is_producer"><a href="/users/profile/orders"> مشتریان من
                    <customers></customers>
                </a></li>
                ...
                <li class="single"><a href="/userpanel/cal_netprice/">محاسبه قیمت تمام شده
                    <finished-price></finished-price>
                </a></li>
                <li class="single"><a href="/userpanel/create_prefactor/">ساخت پیش فاکتور
                    <factore></factore>
                </a></li>
                <li class="single"><a href="/userpanel/catalogue/create/"> ساخت کاتالوگ
                    <catalog></catalog>
                </a></li>
                <li class="single"><a href="/userpanel/catalogue/order/">کاتالوگ به زبان ها دیگر
                    <other-lang-catalog></other-lang-catalog>
                </a></li>
                <li class="single"><a href="/users/userpanel/"> پروفایل
                    <profile></profile>
                </a></li>

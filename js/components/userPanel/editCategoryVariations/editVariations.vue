        ...
        <div class="item" id="table" v-if="showTable">
          <table>
            ...
            <tr class="trs" v-for="vari in vars">
              ...
              <td><input @keyup="handleKey($event)" type="text" :name="vari.id" :value="vari.name"></td>
            ...
            <tr class="trs">
              ...
              <td><input @keyup="handleKey($event)" type="text" name="newVar0"></td>
              <td>
            ...
            <tr class="trs" v-for="(i,ind) in fields">
              ...
              <td><input @keyup="handleKey($event)" type="text" :name="'newVar'+(ind+1)"></td>
              <td>
                <cross @deleteRow="deleteRow($event)"></cross>
              </td>
            </tr>
...
export default {
  ...
  methods: {
    ...
    async levelOneChanged(e) {
      ...
      const {data} = await axios.get(`/categories-api/mother/${this.currentLeveL1Id}`)
    ...
    async levelTwoChanged(e) {
      ...
      const {data} = await axios.get(`/categories-api/mother/${this.currentLeveL1Id}/main/${this.currentLeveL2Id}`)
    ...
    async levelThreeChanged(e) {
      ...
      const {data} = await axios.get(`/categories-api/mother/${this.currentLeveL1Id}/main/${this.currentLeveL2Id}/cat/${this.currentLeveL3Id}`)
      this.vars = data
...
.selfCategories p, .seoPost p {
  font-size: 18px;
  font-weight: bold;
}

#chooseCategory, .chooseCategoryWrapper {
  width: 100%;
}
